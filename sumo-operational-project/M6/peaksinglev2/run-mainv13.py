...
SIMULATION_END_TIME = 55800  # Total simulation time (e.g., 360 seconds)
...
INTERVAL_START = None # Start time for data collection (shared between scenarios) None if attack scenario is enabled
...
def main():
    ...
    ego2_id = 'ego2'
    target_lane_ego2 = '204901083_1'  # Different lane for ego2
    target_position_ego2 = 3001  # Desired position for ego2 to stop
    ego2_stop_time = None
