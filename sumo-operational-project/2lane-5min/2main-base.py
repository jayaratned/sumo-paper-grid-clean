...
SUMO_CONFIG = "2lane.sumocfg"  # Replace with your base SUMO config file
...
DATA_COLLECTION_START = 1102  # Use the same value as determined from the incident scenario
...
def main():
    ...
    try:
        while step <= SIMULATION_DURATION:
            ...
            # Start collecting data once the simulation reaches DATA_COLLECTION_START
        ...
        df.to_csv("base_scenario_data.csv", index=False)
        print("Data collection complete. Results saved to 'base_scenario_data.csv'.")
