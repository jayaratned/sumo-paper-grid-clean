...
collision_vehicles = ['ego', 'flow1.1203', 'flow1.1207', 'flow1.1209']
...
for chunk in pd.read_csv(csv_file_path, sep=';', chunksize=chunksize):
    ...
    filtered_chunk = filtered_columns_chunk[(filtered_columns_chunk['data_timestep'] >= 1900) & (filtered_columns_chunk['data_timestep'] <= 1950)]
