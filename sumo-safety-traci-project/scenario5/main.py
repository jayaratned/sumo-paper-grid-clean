...
while traci.simulation.getTime() <= 60:
    ...
    print('Time: ', traci.simulation.getTime(), traci.simulation.getCollidingVehiclesIDList())
...
# Distance plot
axs[1].plot(times, leader_positions, label='Leader Distance (km)', linestyle='--')
axs[1].plot(times, follower_positions, label='Follower Distance (km)', linestyle='--')
